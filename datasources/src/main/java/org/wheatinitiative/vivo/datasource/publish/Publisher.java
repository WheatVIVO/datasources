...
//                        }
    ...
    /**
     * 
     * @return list of owl:sameAs statements
     * from endpoint
     */
...
//    }
    ...
    private void cacheHomeGraphs(List<String> individualURIs,
            SparqlEndpoint endpoint, List<String> graphURIPreferenceList) {
        if(individualURIs == null || individualURIs.isEmpty()) {
            return;
        }
